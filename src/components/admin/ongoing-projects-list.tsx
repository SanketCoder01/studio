...
export function OngoingProjectsList() {
    const { data, ongoingProjects: { deleteItem, addItem, updateItem } } = usePortfolioData();
    ...
    const handleDelete = (id: string) => {
        ...
        toast({
            ...
            description: "The ongoing project has been removed from your portfolio.",
        });
    }
    ...
    const handleFormSubmit = async (values: Omit<Project, 'id'> | Project) => {
        if ('id' in values) {
            ...
            toast({ title: 'Project Updated', description: 'Your ongoing project has been updated.' });
        } else {
            await addItem(values);
            toast({ title: 'Project Added', description: 'A new ongoing project has been added.' });
        }
        setIsFormOpen(false);
    };
                ...
                <CardHeader>
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <CardDescription>Manage your current projects. Add new ones or edit existing entries.</CardDescription>
                        </div>
