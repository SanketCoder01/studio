          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField control={form.control} name="title" render={({ field }) => (
             ...
             <FormField control={form.control} name="avatar" render={({ field: { onChange, value } }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <FileUpload key={data?.profile?.avatar || 'avatar-upload'} value={value} onChange={onChange} folder="avatars" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
            <FormField control={form.control} name="cvUrl" render={({ field: { onChange, value } }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <FileUpload key={data?.profile?.cvUrl || 'cv-upload'} value={value} onChange={onChange} folder="cvs" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
